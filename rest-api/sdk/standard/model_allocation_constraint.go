...
func (o *AllocationConstraint) GetDeprecations() []Deprecation {
...
// and a boolean to check if the value has been set.
func (o *AllocationConstraint) GetDeprecationsOk() ([]Deprecation, bool) {
	if o == nil || IsNil(o.Deprecations) {
		return nil, false
	}
...
func (o *AllocationConstraint) HasDeprecations() bool {
	if o != nil && !IsNil(o.Deprecations) {
		return true
	}
...
func (o *AllocationConstraint) SetDeprecations(v []Deprecation) {
	o.Deprecations = v
}
